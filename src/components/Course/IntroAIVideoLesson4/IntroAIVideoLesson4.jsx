...
import "../Course.css"
import "./IntroAIVideoLesson4.css"
...
const IntroAIVideoLesson4 = () => {
    const videoId = "bHvf7Tagt18"; // Placeholder video ID for lesson 4

    return (
        <div className='intro-ai-video-lesson4-shell'>
            <Header />
...
export default IntroAIVideoLesson4 