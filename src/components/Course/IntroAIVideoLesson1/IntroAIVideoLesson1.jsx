...
import "../Course.css"
import "./IntroAIVideoLesson1.css"
...
const IntroAIVideoLesson1 = () => {
    const videoId = suggestedVideoData.videoId;

    return (
        <div className='intro-ai-video-lesson1-shell'>
            <Header />
...
export default IntroAIVideoLesson1 