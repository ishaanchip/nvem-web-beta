...
import "../Course.css"
import "./IntroAIVideoLesson5.css"
...
const IntroAIVideoLesson5 = () => {
    const videoId = "kG_-vAJG7kw"; // Placeholder video ID for lesson 5

    return (
        <div className='intro-ai-video-lesson5-shell'>
            <Header />
...
export default IntroAIVideoLesson5 