...
import "../Course.css"
import "./IntroAIVideoLesson3.css"
...
const IntroAIVideoLesson3 = () => {
    const videoId = "TRw4eAZZHuA"; // Placeholder video ID for lesson 3

    return (
        <div className='intro-ai-video-lesson3-shell'>
            <Header />
...
export default IntroAIVideoLesson3 