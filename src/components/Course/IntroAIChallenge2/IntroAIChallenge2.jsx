...
const IntroAIChallenge2 = () => {
    ...
    return (
        <div className='intro-ai-challenge2-shell'>
            <Header />
            ...
            <div className="breadcrumb-nav">
                ...
                <div className="prev-next-nav">
                    ...
                    <Link to="/introai/lesson2/quiz" className="nav-button">
                        Next
            ...
            <div className="main-layout">
                ...
                <div className="content-area">
                    ...
                    <h1 className="content-title">Prompt Engineering Practice</h1>
                    
                    {!isSubmitted ? (
                        <div className="activity-content">
                            <h2>Activity</h2>
                            <p>
                                Go to an AI assistant like ChatGPT, and with only one prompt, make the AI provide the most detailed information about a topic, e.g., frogs, airplanes, or basketball.
                            </p>

                            <div className="questions-container">
                                <div className="question-item">
                                    <h3>1. What topic did you choose for your detailed information prompt?</h3>
                                    <textarea
                                        className="answer-textbox"
                                        value={answers.question1}
                                        onChange={(e) => handleAnswerChange('question1', e.target.value)}
                                        placeholder="Write the topic you chose (e.g., frogs, airplanes, basketball, etc.)..."
                                        rows={2}
                                    />
                                </div>

                                <div className="question-item">
                                    <h3>2. Write the exact prompt you used to get detailed information about your topic:</h3>
                                    <textarea
                                        className="answer-textbox"
                                ...
                                <div className="question-item">
                                    <h3>3. How did you make your prompt specific to get the most detailed information possible?</h3>
                                    <textarea
                                        className="answer-textbox"
                                        value={answers.question3}
                                        onChange={(e) => handleAnswerChange('question3', e.target.value)}
                                        placeholder="Explain the techniques you used to make your prompt effective..."
                                        rows={4}
                                    />
                                </div>

                                <div className="question-item">
                                    <h3>4. Rate the quality of the AI's response (1-10) and explain what made it good or how it could be improved:</h3>
                                    <textarea
                                        className="answer-textbox"
                                        value={answers.question4}
                                        onChange={(e) => handleAnswerChange('question4', e.target.value)}
                                        placeholder="Rate the response and explain your reasoning..."
                                        rows={4}
                                    />
                                </div>
                            </div>
                        ...
                        <div className="submission-success">
                            <div className="success-message">
                                ...
                                <p>Great job practicing your prompt engineering skills! You've learned how to craft effective prompts to get detailed information from AI assistants.</p>
                            </div>
                            ...
                            <div className="submitted-answers">
                                ...
                                <div className="answer-review">
                                    <h4>1. What topic did you choose for your detailed information prompt?</h4>
                                    <div className="submitted-answer">{answers.question1}</div>
                                </div>

                                <div className="answer-review">
                                    <h4>2. Write the exact prompt you used to get detailed information about your topic:</h4>
                                    <div className="submitted-answer">{answers.question2}</div>
                                </div>

                                <div className="answer-review">
                                    <h4>3. How did you make your prompt specific to get the most detailed information possible?</h4>
                                    <div className="submitted-answer">{answers.question3}</div>
                                </div>

                                <div className="answer-review">
                                    <h4>4. Rate the quality of the AI's response (1-10) and explain what made it good or how it could be improved:</h4>
                            ...
                            <div className="activity-actions">
                                ...
                                <Link to="/introai/lesson2/quiz" className="primary-button">
                                    Continue to Quiz
                                </Link>
                            </div>
                        </div>
...
export default IntroAIChallenge2; 